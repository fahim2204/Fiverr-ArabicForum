...
exports.forgetPassValidate = (values) => {
  const errors = {};
...
exports.resetPassValidate = (values) => {
  const errors = {};
  // OTP
  if (!values.otp) {
    errors.otp = "Required";
  } else if (values.otp.length < 3) {
    errors.otp = "Must be greater than or equal to 3 characters";
  }
  ...
  if (!values.confirmPassword) {
    ...
    errors.confirmPassword =
      "Must be greater than 6 and less then 20 characters";
